...
function Signup() {
  ...
  mutation Register($username: String!, $email: String!, $password: String!, $name: String, $dob: Date) {
    register(username: $username, email: $email, password: $password, name: $name, dob: $dob) {
      token
    }
  }
  `
  ...
  const handleSubmit = async (e) => {
    ...
    const rgesiter_res = client.mutate({
    ...
    if (rgesiter_res.data.register.token) {
